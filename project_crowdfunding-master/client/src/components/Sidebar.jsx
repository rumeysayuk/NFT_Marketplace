...
import {webLogo, logout_img} from '../assets';
...
const Sidebar = () => {
   ...
   return (
      <div className="flex justify-between items-center flex-col sticky top-5 h-[93vh]">
         <Link to="/">
            <Icon styles="w-[52px] h-[52px] bg-[#2c2f32]" imgUrl={webLogo}/>
         </Link>
         {address &&<div
            ...
            <button onClick={() => {
               ...
               {address &&<Icon imgUrl={logout_img}/>}
            </button>
            {/*<Icon styles="bg-[#1c1c24] &:hover:shadow-secondary" imgUrl={sun} />*/}
         </div> }
